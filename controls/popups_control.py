...
class PopupsControl:
    ...
    # селекторы
    _chat_close_selector = "#jivo_close_button"
    _subscribe_close_selector = ".p-0.outline-none"
    _cookie_accept_selector = ".btn-primary"

    # локаторы
    def chat_close_locator(self):
        return self.page.locator(self._chat_close_selector)

    def subscribe_close_locator(self):
        return self.page.locator(self._subscribe_close_selector)

    def cookie_accept_locator(self):
        return self.page.locator(self._cookie_accept_selector)
